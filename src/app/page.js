...
const Home = () => {
  ...
  const API_KEY = process.env.NEXT_PUBLIC_MOVIEAPI;
              ...
              <div className="banner-content">
                <div className="imdb">
                  <span className="imbd-btn">
                    <Image src={require("./assets/imdb.png")} alt="imbd" />
                    <p> {randomMovie.vote_average}</p>
                  </span>
                  <span className="imbd-btn">
                    <Image src={require("./assets/rot.png")} alt="imbd" />
                    <p> 97%</p>
                  </span>
                </div>
                <p>{randomMovie.overview}</p>
              </div>
              <div className="banner-button" style={{ zIndex: 20 }}>
